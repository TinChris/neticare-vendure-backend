...
export const config: VendureConfig = {
    ...
    plugins: [
        ...
        AssetServerPlugin.init({
            ...
            // Use ASSET_URL_PREFIX env variable for production
        ...
        EmailPlugin.init({
            // devMode: true writes emails to disk instead of sending
            // For production SMTP, remove devMode and add transport config
            devMode: true,
            ...
            globalTemplateVars: {
                fromAddress: process.env.EMAIL_FROM_ADDRESS || '"Vendure Shop" <noreply@example.com>',
